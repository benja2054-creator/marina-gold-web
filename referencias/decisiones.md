...
- **Hero de escritorio (n.º 21) por rehacer.** En la foto de la parte 2 la tapa de la caja ocupa hasta el 56 % del ancho, a la altura del texto centrado, y a 1440–1920 px el título roza el pelo y el brazo de Marina. Ni `object-position` ni limitar el ancho del texto lo resuelven (el título mide ~700 px a 72 px). Decisión del cliente (2026-09-24): pedir una foto nueva; mientras tanto el hero queda como está (texto centrado, `object-position` 50 % 50 %, velo del 30 % que ya existía).
- Zona libre que debe respetar la foto nueva (medida en el sitio): el bloque de texto ocupa del 33 % al 67 % del alto en todos los anchos, y a lo ancho del 15 % al 85 % a 1024 px, del 26 % al 74 % a 1440 px y del 32 % al 68 % a 1920 px. Ver el encargo en el README.
