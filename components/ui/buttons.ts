...
/** Compra (rojo): AÑADIR AL CARRITO, AÑADIR, UNIRME. Alto 52 (48 en la barra fija). */
export const buyButton = `${base} h-btn-lg bg-mg-red px-4.5 text-mg-button text-mg-on-dark hover:bg-mg-red-hover disabled:bg-mg-ink-3 disabled:cursor-not-allowed`;
